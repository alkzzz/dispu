...
@section('content')
    <h2 class="pb-2 border-bottom border-dark">Edit Link Icon</h2>
    ...
    <div class="row mt-3">
        ...
        @endif
        <form action="{{ route('dashboard.link-icon.update', $linkicon->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mt-2">
                <div class="mb-3">
                    <label for="title" class="form-label">Judul Link</label>
                    <input type="text" class="form-control" id="title" name="title" value="{{ $linkicon->title }}"
                        required>
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="url" name="url" value="{{ $linkicon->url }}"
                        required>
                </div>
                <div class="mb-3">
